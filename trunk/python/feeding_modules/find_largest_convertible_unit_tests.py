from find_largest_convertible_unit import find_largest_convertible_unit
import unittest
...
class find_largest_convertible_unit_tests ( unittest . TestCase ) :
    def setUp ( self ) :
    ...
    def test_sorted_keys ( self ) :
        ...
        result = self . _find_largest_convertible_unit . run ( test_consts . my_unit )
        self . assertEqual ( result , test_consts . value1 )
